...
//        return mazeGenerator.getRawMaze();
        ...
        if (game.getLevel() == 0) {
            ...
            return new char[][]{
                    {'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h'},
                    {'h', 'P', 'e', 'e', 'e', 'h', 'c', 'h', 'e', 'e', 'e', 'h', 'e', 'e', 'e', 'p', 'e', 'h', 'e', 'h'},
                    {'h', 'h', 'p', 'h', 'e', 'h', 'e', 'h', 'h', 'h', 'h', 'h', 'e', 'h', 'h', 'h', 'e', 'e', 'e', 'h'},
                    {'h', 'e', 'e', 'e', 'g', 'h', 'e', 'e', 'g', 'h', 'e', 'e', 'e', 'h', 'e', 'e', 'e', 'e', 'h', 'h'},
                    {'h', 'e', 'h', 'h', 'h', 'h', 'e', 'h', 'h', 'h', 'e', 'h', 'e', 'h', 'h', 'h', 'e', 'h', 'c', 'h'},
                    {'h', 'e', 'h', 'e', 'e', 'e', 'e', 'e', 'e', 'h', 'e', 'h', 'e', 'h', 'e', 'e', 'e', 'h', 'e', 'h'},
                    {'h', 'e', 'e', 'e', 'h', 'e', 'e', 'h', 'e', 'h', 'e', 'h', 'e', 'h', 'e', 'h', 'e', 'h', 'e', 'h'},
                    {'h', 'e', 'h', 'e', 'h', 'h', 'e', 'h', 'e', 'h', 'e', 'e', 'e', 'h', 'e', 'h', 'e', 'h', 'e', 'h'},
                    {'h', 'e', 'e', 'e', 'e', 'e', 'e', 'h', 'e', 'e', 'e', 'h', 'h', 'h', 'e', 'h', 'e', 'e', 'e', 'h'},
                    {'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'E', 'e', 'h', 'h', 'h', 'h', 'h'},
                    {'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h'},
                    {'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h'}
            };
            ...
            return new char[][] {
                    {'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h'},
                    {'h', 'P', 'e', 'e', 'e', 'h', 'e', 'c', 'h', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 'h'},
                    {'h', 'e', 'h', 'h', 'e', 'h', 'e', 'h', 'h', 'e', 'h', 'h', 'h', 'h', 'h', 'h', 'e', 'h', 'e', 'h'},
                    {'h', 'e', 'e', 'e', 'e', 'h', 'p', 'h', 'e', 'e', 'e', 'e', 'h', 'c', 'e', 'h', 'e', 'e', 'e', 'h'},
                    {'h', 'e', 'h', 'e', 'h', 'e', 'e', 'h', 'e', 'h', 'e', 'h', 'h', 'h', 'e', 'h', 'h', 'e', 'e', 'h'},
                    {'h', 'e', 'h', 'e', 'h', 'e', 'e', 'h', 'e', 'e', 'e', 'h', 'e', 'h', 'p', 'h', 'h', 'e', 'h', 'h'},
                    {'h', 'e', 'e', 'e', 'e', 'e', 'h', 'h', 'h', 'h', 'e', 'h', 'e', 'e', 'e', 'e', 'h', 'e', 'p', 'h'},
                    {'h', 'e', 'h', 'e', 'h', 'h', 'h', 'e', 'e', 'e', 'e', 'h', 'e', 'h', 'h', 'h', 'h', 'h', 'e', 'h'},
                    {'h', 'e', 'e', 'e', 'e', 'h', 'e', 'e', 'h', 'e', 'e', 'e', 'e', 'e', 'h', 'e', 'h', 'c', 'e', 'h'},
                    {'h', 'h', 'h', 'h', 'e', 'e', 'e', 'h', 'h', 'h', 'h', 'h', 'h', 'E', 'h', 'h', 'h', 'h', 'h', 'h'},
                    {'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h'}
            };
